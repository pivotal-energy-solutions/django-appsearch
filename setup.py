...
setup(
    ...
    description='Framework and generic app for cross-model searches on a single page',  # Required
    ...
    keywords='django search',  # Optional
    ...
    install_requires=['django>=1.11,<2.0'],  # Optional
    ...
    package_data={  # Optional
        'appsearch': ['static/js/*.js', 'templates/appsearch/*.html'],
    },
